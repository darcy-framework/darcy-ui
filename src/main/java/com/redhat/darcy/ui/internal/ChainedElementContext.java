 ...
 * other locator, effectively turning all locators passed to this context to {@link com.redhat.darcy.ui.By.ByChained}
 * {@link com.redhat.darcy.ui.api.Locator} types.
 * <P>
...
public class ChainedElementContext implements ForwardingElementContext {
     ...
     * @param parentLocator
     * @return
     * @see ForwardingElementContextHandler
     */
    public static ElementContext makeChainedElementContext(ElementContext context,
        ...
        return (ElementContext) Proxy.newProxyInstance(
                ...
                new ForwardingElementContextHandler(
    ...
    /**
     * Transforms a locator to a {@link com.redhat.darcy.ui.By.ByChained} Locator.
     * @param locator
     * @return
     */
