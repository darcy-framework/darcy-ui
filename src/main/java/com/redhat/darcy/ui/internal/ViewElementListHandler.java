 ...
 * <p>
 * One notable difference is the use of {@link com.redhat.darcy.ui.internal.NestedElementContext} instead of {@link
 * com.redhat.darcy.ui.internal.ChainedElementContext}. This is because each resulting View must be associated with one of the
 * many possible elements found by the given locator. We can't simply use the locator as the parent
 * for each View (as in {@link com.redhat.darcy.ui.internal.ChainedElementContext}), because each View could, and probably would,
 ...
 * @see com.redhat.darcy.ui.internal.NestedElementContext
 */
